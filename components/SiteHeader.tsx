...
export function SiteHeader() {
  ...
  return <header className="site-header"><div className="nav-shell">
    ...
    <ContactActions variant="header" phoneLabel="090-249-1459"/>
